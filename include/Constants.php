...
//Database Connection
define('DB_NAME','stock');   //your database username
define('DB_USER', 'root');          //your database name
define('DB_PASS', '');              //your database password
define('DB_HOST', 'localhost');     //your database host name


define('WEBSITE_DOMAIN', 'http://localhost/youtube/api/public/');
...
//Guys, If you like the project, Please don't forgot to support us. thanks
